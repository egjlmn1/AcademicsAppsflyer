...
class PostObj(val post_id : String, val type : String, val sub_type : String, val date : String, val flair : String?, val publisher : String, val text_content : String?, val attachment : AttachmentObj?) {}
